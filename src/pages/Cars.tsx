...
import { getCars, type Item } from '../services/storage'
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      <div className="flex items-center gap-3">
        <input className="w-64 px-3 py-2 rounded-lg bg-slate-800 border border-white/10" placeholder="Search cars" value={q} onChange={(e) => setQ(e.target.value)} />
